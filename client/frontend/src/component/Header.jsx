...
const Header = () => {
  ...
  return (
    <header className="bg-gray-800 text-white p-4 fixed top-0 left-0 w-full z-10 flex flex-col md:flex-row items-center justify-between">
      ...
      <nav className={`flex-col md:flex-row md:flex md:items-center md:space-x-4 absolute md:static w-full md:w-auto bg-gray-800 ${menuOpen ? 'flex' : 'hidden'} md:flex`}>
        {menuOpen ? (
